...
$(function(){
    ...
    <body class="<?php echo $pagina; ?>"> <!--Nos devuelve la pagina actual y nos servira en el js para sabaer donde se encuentra el usuario actualmente-->
        <!--[if lte IE 9]>
            ...
            <div class="informacion-evento">
               <div class="clearfix">
                <p class="fecha"><i class="fa fa-calendar" aria-hidden="true"></i>
                   ...
                   <p id="fecha_dia" class="fechas"></p> <p class="separacion">/</p>
                   <p id="fecha_mes" class="fechas"></p> <p class="separacion">/</p>
      ...
      <div class="barra">
          <div class="contenedor clearfix">
              ...
              <nav class="navegacion-principal clearfix">
                 ...
                 <a href="registro.php">Inicio de sesión / Registro</a>
              </nav>
          </div><!--contenedor-->
      </div><!--barra-->