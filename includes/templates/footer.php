...
<div style="display: none;"> <!-- para que no se vea el formulario abajo del footer -->
...
<script src="admin/js/bootstrap-datepicker.min.js"></script>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD_5ZluF-VDv-e1qcQz0s-qKQ-WpwYypps&callback=initMap"
    async defer></script>
        ...
        <!-- MailChimp -->
        <script type="text/javascript" src="//downloads.mailchimp.com/js/signup-forms/popup/unique-methods/embed.js" data-dojo-config="usePlainJson: true, isDebug: false"></script><script type="text/javascript">window.dojoRequire(["mojo/signup-forms/Loader"], function(L) { L.start({"baseUrl":"mc.us19.list-manage.com","uuid":"5009ca6753ea56561b465b171","lid":"53fd42ce3a","uniqueMethods":true}) })</script>
