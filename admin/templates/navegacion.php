    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="lista-usuarios.php"><i class="fas fa-list-ul" aria-hidden="true"></i> &nbsp;<span>Ver Todos</span> </a></li>
            <li><a href="crear-usuario.php"><i class="fas fa-plus-circle" aria-hidden="true"></i> &nbsp;<span>Agregar</span></a></li>
          </ul>
        </li>
