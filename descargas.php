    ...
    <form class="search-form" action="descargas.php" method="POST">
        <div class="input-group busqpdf">
            ...
            <div class="input-group-btn">
                <button type="submit" name="submit" class="btn btn-danger btn-flat" title="Buscar"><i
...
try {
     ...
     while ($partitura = $resultado->fetch_assoc()) {?>
                                <tr>
                                    <!-- <td><embed src="pdf/<?php //echo $partitura['nombre_partitura'] ?>" type="application/pdf" width="150px" height="212px"> </td> -->
                                    <td>
